...
namespace InspectorGadgets.Editor
{
    ...
    internal sealed class TransformEditor : UnityEditor.Editor
    {
        ...
        public static readonly AutoPrefs.EditorBool
            DefaultToUniformScale = new AutoPrefs.EditorBool(Strings.PrefsKeyPrefix + nameof(DefaultToUniformScale), true),
            IsLocalMode = new AutoPrefs.EditorBool(Strings.PrefsKeyPrefix + nameof(IsLocalMode), true),
            OverrideTransformGizmos = new AutoPrefs.EditorBool(Strings.PrefsKeyPrefix + nameof(OverrideTransformGizmos), true),
            FreezeChildTransforms = new AutoPrefs.EditorBool(Strings.PrefsKeyPrefix + nameof(FreezeChildTransforms), false),
            DrawAllGizmos = new AutoPrefs.EditorBool(Strings.PrefsKeyPrefix + nameof(DrawAllGizmos), false);
        ...
        private void DoModeButtons(ref Rect area)
        {
            ...
            var buttonArea = area;
            buttonArea.width = InternalGUI.MiniSquareButtonStyle.fixedWidth;

            area.xMin += buttonArea.width;

            var guiEnabled = GUI.enabled;

            buttonArea.height = InternalGUI.MiniSquareButtonStyle.fixedHeight;

            // Local / World.
            var label = CurrentIsLocalMode ? Strings.GUI.LocalMode : Strings.GUI.WorldMode;
            if (GUI.Button(buttonArea, label, InternalGUI.MiniSquareButtonStyle))
            {
            ...
            var height = InternalGUI.MiniSquareButtonStyle.fixedHeight + IGEditorUtils.Spacing;
            buttonArea.y += height;
            ...
            CurrentFreezeChildTransforms = GUI.Toggle(buttonArea, CurrentFreezeChildTransforms,
                Strings.GUI.FreezeChildTransforms, InternalGUI.MiniSquareButtonStyle);
            ...
            if (GUI.Toggle(buttonArea, DrawAllGizmos, Strings.GUI.DrawAllGizmos, InternalGUI.MiniSquareButtonStyle) != DrawAllGizmos)
            {
