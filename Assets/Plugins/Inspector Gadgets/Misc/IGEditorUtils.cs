...
namespace InspectorGadgets.Editor
{
    ...
    public static partial class IGEditorUtils
    {
        ...
        [MenuItem(Strings.RemoveAllComponents)]
        ...
        [MenuItem(Strings.MainNewLockedInspector)]
        ...
        {
            get => EditorPrefs.GetFloat("MoveSnapX", 1);
        ...
        {
            get => EditorPrefs.GetFloat("MoveSnapY", 1);
        ...
        {
            get => EditorPrefs.GetFloat("MoveSnapZ", 1);
            set => EditorPrefs.SetFloat("MoveSnapZ", value);
        }

        /// <summary>(<see cref="MoveSnapX"/>, <see cref="MoveSnapY"/>, <see cref="MoveSnapZ"/>).</summary>
        public static Vector3 MoveSnapVector
        {
            get => new Vector3(MoveSnapX, MoveSnapY, MoveSnapZ);
            set
            {
                MoveSnapX = value.x;
                MoveSnapY = value.y;
        ...
        {
            get => EditorPrefs.GetFloat("RotationSnap", 15);
        ...
        {
            get => EditorPrefs.GetFloat("ScaleSnap", 0.1f);
