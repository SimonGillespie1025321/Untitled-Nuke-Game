...
namespace InspectorGadgets
{
    ...
    public static class Strings
    {
        ...
        public const string InspectorGadgetsVersion = "6.9";
        ...
        // Some of the following constants aren't using nameof statements due to referencing issues in InspectorGadgets.Lite.dll.
